...
def exprdir2model(expr_dir):
    ...
    expr_dir = r"C:\Users\Steven\NYCU-DLP-Final\human_body_prior\support_data\dowloads\vposer_v2_05"
    ...
    #print(f"The dir is {model_snapshots_dir}")
    ...
    model_ps_fname = r"C:\Users\Steven\NYCU-DLP-Final\human_body_prior\support_data\dowloads\vposer_v2_05\V02_05.yaml"
